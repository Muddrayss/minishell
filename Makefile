...
#    Updated: 2024/03/02 00:49:57 by craimond         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
GENERAL_UTILS_SRCS = $(addprefix general/, ft_freematrix.c ft_atou.c ft_isdigit.c ft_matrixsize.c ft_utoa.c ft_calloc.c ft_freenull.c)
