...
#    Updated: 2024/03/03 00:51:42 by craimond         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
GENERAL_UTILS_SRCS = $(addprefix general/, ft_freematrix.c ft_atoi.c ft_isdigit.c ft_matrixsize.c ft_itoa.c ft_calloc.c free_and_null.c)
