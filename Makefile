...
#    Updated: 2024/03/02 15:02:58 by craimond         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
GENERAL_UTILS_SRCS = $(addprefix general/, ft_freematrix.c ft_atou.c ft_isdigit.c ft_matrixsize.c ft_utoa.c ft_calloc.c free_and_null.c)
...
TREE_UTILS_SRCS = $(addprefix tree/, tree_size.c treeadd_below.c treeclear.c treenew_p.c tree_first.c)
...
leaks: all
	@valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes --suppressions=readline.supp ./$(NAME) 2> leak_report
